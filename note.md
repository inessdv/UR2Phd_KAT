...
`S1, δ1*, ϵ1*, ϵ̂1, δ̂1` is the automata generated inductively generated by `e1`,
and similarly for `S2, δ2*, ϵ2*, ϵ̂2, δ̂2`.
...
δ̂ = ϵ̂ = !
```
where ! is the unique function from empty set `!: ∅ → A`.
...
ϵ* = (b ∧ ϵ1*) ∨ (¬ b ∧ ϵ1*);
δ* = 
    {b ∧ ϕ ↦ (s', p) ∣ ϕ ↦ (s', p) ∈ δ1*} ∪    # taking the left branch
    {¬ b ∧ ϕ ↦ (s', p) ∣ ϕ ↦ (s', p) ∈ δ2*}    # taking the right branch
ϵ̂ = ϵ̂1 + ϵ̂2
δ̂ = δ̂1 + δ̂2
```
